...
define([
    ...
    //             };
    //
    //             this.popUpFormEdit.options.modalCloseBtnHandler = this.onClosePopUp.bind(this);
    ...
    //             };
    //             popUp = modal(this.popUpFormEdit.options, $(this.popUpFormEdit.element));
    //         }
    //
    //         return popUp;
    //     },
    ...
    //                 if (addressditData.hasOwnProperty(field) &&  //eslint-disable-line max-depth
    ...
    //     }
        ...
        showPopup: function () {
            ...
            $('[data-open-modal="opc-new-shipping-address111"]').trigger('click');

            // var custom_fild = document.createElement("input");
            // custom_fild.classList.add('custom_input_fild');
            // custom_fild.setAttribute("type", "hidden");
            ...
            // $('.action-hide-popup').on('click', function() {
            //     $('.modal-inner-wrap').last().find('.action-save-address').css('display','block');
            //     $('.custom_btn').css('display','none');
            // });
            ...
            if(document.querySelector('.custom_btn')===null) {
                ...
                // document.querySelector(".custom_btn").attr('data-binde', '{ClosePopUp}');
